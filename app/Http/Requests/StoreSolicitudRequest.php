...
class StoreSolicitudRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'motivo_visita'         => 'required|string|exists:ca_motivo_visita,nombre',
    ...
    public function messages(): array
    {
        return [
            ...
            'motivo_visita.required'      => 'Seleccione el motivo de visita.',
            'motivo_visita.exists'        => 'El motivo seleccionado no es válido.',
