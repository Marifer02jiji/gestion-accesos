...
<body class="bg-omg-chardon min-h-screen flex items-center justify-center">
    <div class="text-center p-8">
        <div class="bg-white rounded-xl shadow-sm p-10 max-w-md mx-auto">
            ...
            <h1 class="font-heading font-bold text-omg-nile text-4xl mb-2">403</h1>
            <h2 class="font-heading font-bold text-omg-nile text-xl mb-4">Acceso No Autorizado</h2>
            <p class="text-omg-slate text-sm mb-6">No tienes permisos para acceder a esta página.</p>
