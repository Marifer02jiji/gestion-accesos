                ...
                <table width="600" cellpadding="0" cellspacing="0" style="max-width:600px;background:#ffffff;border-radius:8px;overflow:hidden;box-shadow:0 2px 8px rgba(0,0,0,0.08);">
                    <tr>
                        <td style="background:#DA7E2D;color:#ffffff;padding:20px 24px;text-align:center;">
                            <h1 style="margin:0;font-size:20px;font-weight:bold;">Gestion de Accesos -- IT Toluca</h1>
                    ...
                    <tr>
                        <td style="padding:24px;">
                            ...
                            <p style="margin:0 0 16px;line-height:1.5;">
                                Tu solicitud de acceso ha sido autorizada. Presenta el siguiente codigo QR en la entrada del campus.
                            </p>

                            {{-- Folio: solo XXXX-XXXX --}}
                            ...
                            {{-- Codigo de validacion: VIS-XXXX-XXXX --}}
                            <p style="margin:20px 0 4px;text-align:center;font-size:12px;color:#999;">
                                Codigo de validacion manual
                            </p>
                            <p style="margin:0;text-align:center;font-size:22px;font-weight:bold;letter-spacing:3px;color:#DA7E2D;">
                                {{ $qr->codigo_numerico }}
                            </p>
                            <p style="margin:12px 0 0;font-size:12px;color:#666;line-height:1.5;text-align:center;">
                                Si el personal de vigilancia no puede escanear el adjunto, indica el codigo de arriba.
                            </p>
                        </td>
                    </tr>
                    <tr>
